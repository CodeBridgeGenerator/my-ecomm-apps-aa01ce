...
const p_dateTemplate2 = (rowData, { rowIndex }) => <p >{(new Date(rowData.expiryDate)).toLocaleDateString()}</p>
const p_numberTemplate3 = (rowData, { rowIndex }) => <p >{rowData.limit}</p>
const p_numberTemplate4 = (rowData, { rowIndex }) => <p >{rowData.redeemedCount}</p>
const dropdownTemplate5 = (rowData, { rowIndex }) => <p >{rowData.createdBy?.email}</p>
...
<Column field="expiryDate" header="ExpiryDate" body={p_dateTemplate2} filter={selectedFilterFields.includes("expiryDate")} hidden={selectedHideFields?.includes("expiryDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="limit" header="Limit" body={p_numberTemplate3} filter={selectedFilterFields.includes("limit")} hidden={selectedHideFields?.includes("limit")}  sortable style={{ minWidth: "8rem" }} />
<Column field="redeemedCount" header="RedeemedCount" body={p_numberTemplate4} filter={selectedFilterFields.includes("redeemedCount")} hidden={selectedHideFields?.includes("redeemedCount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="createdBy" header="CreatedBy" body={dropdownTemplate5} filter={selectedFilterFields.includes("createdBy")} hidden={selectedHideFields?.includes("createdBy")}  style={{ minWidth: "8rem" }} />
